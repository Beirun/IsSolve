import {
  ...
  import {IconBell, IconSearch, IconArrowLeft} from "@tabler/icons-react"
  ...
  const Navbar = ({logoRoute, isDashboard}) => {
    ...
    const { signedInAccount, setSignedInAccount, setSignUpClicked, setIsAdmin } = useCurrent();
    ...
    return (
      ...
      >
        ...
        >
          <img
            src={logoRoute ? "../../src/resources/LOGO-WHITE.png" : "../src/resources/LOGO-WHITE.png"}
            alt="IsSolve"
            style={{ width: "12.5vh" }}
          />
          <Button
